...
### Building low-latency communication, media, and backend systems.

![Focus](https://img.shields.io/badge/Focus-Real--time%20Media-0EA5E9?style=flat-square)
![Mindset](https://img.shields.io/badge/Mindset-Build%20%26%20Ship-F97316?style=flat-square)
...
- 🎙️ Real-time audio and video experiences with **WebRTC**, **FFmpeg**, and **SDL**
- 🖥️ Native desktop applications with **C/C++** and **Qt**
- ⚙️ Practical backend systems and developer tools with **Go**
...
| Media | WebRTC, FFmpeg, SDL, OpenCV, RTMP |
| Systems | Linux, networking, epoll, thread pools |
| Apps & data | Qt, Android, Redis, SQLite |

## Engineering interests

**Low-latency systems** · **Media pipelines** · **Networking** · **Developer experience** · **Useful software**

<div align="center">

> Build clearly. Learn continuously. Ship things that work.
